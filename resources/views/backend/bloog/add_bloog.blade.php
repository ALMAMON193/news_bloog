        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="addBloogForm" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label class="form-label" for="Title">Author <span class="text-danger">*</span></label>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="tags" name="tags" value="dfddf,dfd" class="form-control"
                            data-role="tagsinput" />
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="short_description">Short Decsription<span
                                class="text-danger">*</span></label>
                        <input type="text" id="short_description" name="short_description" class="form-control" />
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="Long_description">Long Description<span
                                class="text-danger">*</span></label>
                        <textarea id="long_description" name="long_description" cols="10" rows="30" class="form-control"
                            placeholder="Enter Long description here"></textarea>
                    </div>
                    <div class="mb-3">
